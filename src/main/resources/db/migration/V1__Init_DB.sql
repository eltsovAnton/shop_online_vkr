create sequence clothe_id_seq start 109 increment 1;
...
(
    ...
    clothe_gender         varchar(255) not null,
    clothe_title          varchar(255) not null,
    clothe_color               varchar(255) not null,
    price                  int4 not null,
...
create table users_clothe_list
(
    user_id         int8 not null,
    clothe_list_id int8 not null
);
alter table if exists orders
    add constraint FK32ql8ubntj5uh44ph9659tiih foreign key (user_id) references users;
alter table if exists orders_clothes
    add constraint FK9c3l5vucp0yrrwpc0v8vk8knt foreign key (clothes_id) references clothes;
alter table if exists orders_clothes
...
alter table if exists users_clothe_list
    add constraint FK9neiuundys2yde15o8tcybbvw foreign key (clothe_list_id) references clothes;
alter table if exists users_clothe_list
