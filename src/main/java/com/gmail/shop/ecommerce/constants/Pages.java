package com.gmail.shop.ecommerce.constants;

public class Pages {
    public static final String ADMIN_CLOTHES = "admin-clothes";
    public static final String ADMIN_EDIT_CLOTHE = "admin-edit-clothe";
    public static final String ADMIN_ADD_CLOTHE = "admin-add-clothe";
