...
import com.gmail.shop.ecommerce.service.OrderService;
...
public class OrderController {
    ...
    public String getOrdering(Model model) {
        model.addAttribute("clothes", orderService.getOrdering());
    ...
    public String postOrder(@Valid OrderRequest orderRequest, BindingResult bindingResult, Model model) {
        ...
        if (controllerUtils.validateInputFields(bindingResult, model, "clothes", user.getClotheList())) {
            return Pages.ORDERING;
        }
